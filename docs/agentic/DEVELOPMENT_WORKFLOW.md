...
- Plan 46 local-service observation must verify default-off gating, loopback-only HTTP, GET/HEAD-only methods, no redirect following, no credentials/proxy/browser behavior, bounded bodies/timeouts, and redaction.
