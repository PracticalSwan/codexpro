...
- [x] **Step 2: Add concise deterministic routing text**
...
- [x] **Step 3: Include material-progress behavior**
...
- [x] **Step 2: Implement deterministic classification only**
...
- [x] **Step 3: Surface hints additively**
...
- [x] **Step 1: Update the reusable ChatGPT prompt**
...
- [x] **Step 2: Add workflow examples**
...
- [x] **Step 3: Add developer implementation guidance**
...
- [x] **Step 1: Run focused instruction/routing tests**

Run: `node scripts/execution-routing-smoke.mjs`
Run: `npm run build`
Expected: PASS.

- [x] **Step 2: Run shared MCP/docs gate**
