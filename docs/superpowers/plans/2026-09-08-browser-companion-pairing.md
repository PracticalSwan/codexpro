...
- [x] **Step 1: Write failing pairing/auth tests**
...
- [x] **Step 2: Implement separate browser credential store**
...
- [x] **Step 3: Add loopback-only routes**
...
- [x] **Step 1: Add static manifest/security assertions**
...
- [x] **Step 2: Implement background bridge polling**
...
- [x] **Step 3: Implement minimal popup states**
...
- [x] **Step 1: Add CLI contract tests**
...
- [x] **Step 2: Add explicit manual extension-install gate**
...
- [x] **Step 3: Verify wrong-origin and revoked-client failures**
...
- [x] **Step 1: Ensure extension files are included without browser state**
