...
- [ ] **Step 1: Add failing discovery/path tests**
...
- [ ] **Step 2: Implement dedicated profile resolution**
...
- [ ] **Step 3: Verify no primary-profile discovery/copy exists**
...
- [ ] **Step 1: Add launcher argument tests**

Assert launch uses the dedicated `--user-data-dir`, loads only the CodexPro continuation extension, opens `https://chatgpt.com/`, and never enables remote-debugging, disables browser security, or reuses a personal profile path. Browser crash/update/extension-unload states must degrade to `unknown/unavailable` rather than silently recreating trust or switching to another profile.

- [ ] **Step 2: Implement owned-process metadata**
...
- [ ] **Step 1: Add signed-in/signed-out fixture assertions**
...
- [ ] **Step 2: Fail closed on ambiguity**
...
- [ ] **Step 1: Reach the manual-auth boundary**
...
- [ ] **Step 2: STOP for user authentication**
...
- [ ] **Step 3: Resume only after user's `continue`**
...
- [ ] **Step 2: Inspect privacy artifacts**
