...
- [x] **Step 1: Add redaction/boundedness tests**
...
- [x] **Step 2: Record lifecycle events at canonical boundaries**
...
- [x] **Step 2: Add timeout-risk inventory**
...
- [x] **Step 1: Add probe safety/abort tests**
...
- [x] **Step 2: Add discovery guidance**
...
- [x] **Step 2: Run stress only if job/process telemetry concurrency changed**

Run: `npm run stress`
Expected: PASS when required by the actual implementation diff.

- [x] **Step 3: Check docs/diff and commit milestone**
