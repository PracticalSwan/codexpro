...
- [ ] **Step 2: Implement the minimal Bot API client**
...
- [ ] **Step 3: Add masked local token commands**
...
- [ ] **Step 1: Add pairing and identity tests**
...
- [ ] **Step 1: Test webhook/update-mode conflict**
...
- [ ] **Step 2: Implement condition-based long polling**
...
- [ ] **Step 3: Make stale/backlogged updates harmless**
...
- [ ] **Step 4: Guard duplicate consumers**
...
**Interfaces:**
- Creates at most one active Telegram notification message per task revision/nonce and up to four buttons: default continuation plus up to three safe focused intents registered in current continuation state.
...
- [ ] **Step 1: Add continuation-intent contracts**
...
- [ ] **Step 2: Add privacy-safe Telegram rendering tests**
...
- [ ] **Step 1: Acknowledge callback queries promptly**
...
- [ ] **Step 4: Support focused continuation without arbitrary remote prompts**
...
- [ ] **Step 3: Add revoke/disable behavior**
...
- [ ] **Step 4: Handle bot blocked/API outage safely**
...
- [ ] **Step 1: Run deterministic Telegram gates**
...
- [ ] **Step 2: Perform one live private-bot authorization cycle**
...
- [ ] **Step 3: Verify privacy/package boundaries**
