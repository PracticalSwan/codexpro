...
const transport = new StdioClientTransport({
  ...
  env: { ...process.env, CODEXPRO_HOME: mcpHome, CODEXPRO_OPERATION_DIR: path.join(mcpHome, 'operations'), CODEXPRO_ACTIVITY_DIR: mcpActivity, CODEXPRO_ALLOW_NO_HTTP_TOKEN: '1' }
});
