...
Fresh-user setup should work from the GitHub Release artifact (`https://github.com/PracticalSwan/codexpro/releases/download/v0.33.0/codexpro-full-0.33.0.tgz`) or a verified source checkout. The upstream `npx codexpro@latest` path is not a fork release channel.
