...
## Unreleased
- Refreshed GitHub-facing documentation and Pages: clearly distinguish stable 0.32.3 from post-0.32.3 `main`, surface long-lived OpenAI tunnel recovery without implying it ships in the tagged artifact, update ChatGPT Apps/Developer-mode setup wording to current OpenAI guidance, correct the continuation-vs-launcher tunnel-recovery security boundary, and add canonical/social metadata plus crawl files for the English/Chinese Pages site.
